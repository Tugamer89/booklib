        ...
        <div class="mb-8 p-6 bg-white dark:bg-slate-800 rounded-lg shadow-md border border-slate-200 dark:border-slate-700">
            <form @submit.prevent="apply">
                <div class="border-b border-slate-200 dark:border-slate-700 pb-6 mb-6">
                    <h3 class="text-lg font-semibold text-slate-700 dark:text-slate-200">Filtra per</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                        <div>
                            <label for="filter-title" class="block text-sm font-medium text-slate-600 dark:text-slate-300">Titolo</label>
                            <input v-model="filters.title" type="text" id="filter-title" class="mt-1 input-style">
                        </div>
                        <div>
                            <label for="filter-author" class="block text-sm font-medium text-slate-600 dark:text-slate-300">Autore</label>
                            <input v-model="filters.author" type="text" id="filter-author" class="mt-1 input-style">
                        </div>
                        <div>
                            <label for="filter-publisher" class="block text-sm font-medium text-slate-600 dark:text-slate-300">Editore</label>
                            <input v-model="filters.publisher" type="text" id="filter-publisher" class="mt-1 input-style">
                        </div>
                        <div>
                            <label for="filter-location" class="block text-sm font-medium text-slate-600 dark:text-slate-300">Posizione</label>
                ...
                <div>
                    <h3 class="text-lg font-semibold text-slate-700 dark:text-slate-200">Ordina per</h3>
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                        <div class="sm:col-span-2">
                            <label for="sort-by" class="block text-sm font-medium text-slate-600 dark:text-slate-300">Criterio</label>
                            <select v-model="filters.sort_by" id="sort-by" class="mt-1 input-style">
                                <option value="id">Data Aggiunta</option>
                        ...
                        <div>
                            <label for="sort-order" class="block text-sm font-medium text-slate-600 dark:text-slate-300">Direzione</label>
                ...
                <div class="flex justify-end space-x-3 mt-6 border-t border-slate-200 dark:border-slate-700 pt-4">
                     ...
                     <button type="submit" class="bg-indigo-600 text-white px-4 py-2 rounded-md shadow hover:bg-indigo-700 transition">Applica</button>
                </div>
            </form>
        </div>
    `,
