function formatISBN10(value: string): string {
    return value.replaceAll(/^(\d)(\d{3})(\d{5})(\d|X)$/g, "$1-$2-$3-$4");
}

function formatISBN13(value: string): string {
...
function liveFormatISBN10(value: string): string {
    return value.replaceAll(/^(\d?)(\d{0,3})(\d{0,5})(\d?)$/g, function (_, a, b, c, d) {
        return [a, b, c, d].filter(Boolean).join("-");
    });
}

function liveFormatISBN13(value: string): string {
...
export function liveFormatISBN(value: string): string {
